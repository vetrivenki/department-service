pipeline {
    ...
    stages {
        stage('Cloning Git') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'f8b7d8fd-4a7c-4e71-a7ec-7a5f270b76a0', url: 'git@github.com:vetrivenki/
department-service.git']]])
            }
        }
